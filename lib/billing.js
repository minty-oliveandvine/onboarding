 ...
 *
 * Account-wide, not per-entity — one payer has one Stripe customer with one default,
 * shared by every entity they pay for. Choosing here re-points their others too.
 */
 ...
 */
export function authorizeBilling(token, entityId) {
